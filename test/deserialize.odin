...
test_initial_packet :: proc(t: ^testing.T) {
	...
	testing.expectf(t, len(remaining_data) == 0, "Expected remaining data to be nil.")
...
test_handshake_packet :: proc(t: ^testing.T) {
	...
	decrypted_crypto_frame := []u8{
		 ,
		...
		,
		...
		
	}
	...
	expect_array_match(t, decrypted_crypto_frame, pkt_crypto_frame.crypto_data, "crypto_data")
